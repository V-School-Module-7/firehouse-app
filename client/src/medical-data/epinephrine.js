    ...
    conditions: [
            ...
            weights: [
                {
                    ...
                    notes: "ADULT: titrate to maintain a SBP>100 mmHg;"
                },
                {
                    amounts: "Pediatric",
                    dosage: "0.1-2 mcg/kg/min IV/IO infusion for hypoperfusion",
                    notes: "PEDIATRIC: Titrate to maintain a SBP>70 + (age in years * 2) mmHg"
                }
            ]
        },
        {
            ...
            weights: [
                {
                    amounts: "Adult",
                    dosage: "0.3 cc IM",
                    notes: "If symptoms persist, may repeat every 10 min until symptoms improve"
                },
                {
                    amounts: "Pediatric",
                    dosage: "0.15 cc IM",
        ...
        },
        {
            ...
            weights: [
                {
                    amounts: "Adult",
                    dosage: "2 mL mixed with 3 mL of Normal Saline via nebulizer every 10 min until symptoms improve"
                },
                {
                    amounts: "Pediatric",
                    dosage: "2 mL mixed with 3 mL of Normal Saline via nebulizer every 10 min until symptoms improve"
        ...
        },
        {
            ...
            weights: [
                ...
                },
                {
                    ...
                    notes: "for HR <60/min despite 30 secongs of effective CPR with PPV"
                },
                {
                    amounts: "3.5 kg",
            ...
            weights: [
                {
                    ...
                    notes: "May repeat every 5 min if shock persists"
                },
                {
                    amounts: "Pediatric",
        ...
        },
        {
            ...
            weights: [
                ...
                {
                    notes: "For Bradycardia/Hypotension unresponsive to Atropine, Repeat every 3-5 min as needed to maintain SBP"
                }
            ]
        }
    ]
